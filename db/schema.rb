...
ActiveRecord::Schema.define(version: 2020_09_01_102032) do
  ...
  create_table "spree_posts_stores", id: false, force: :cascade do |t|
    t.integer "store_id"
    t.integer "post_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_spree_posts_stores_on_post_id"
    t.index ["store_id"], name: "index_spree_posts_stores_on_store_id"
  end
